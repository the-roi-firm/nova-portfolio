  ...
  return (
    <section className="bg-accent px-6 py-24 text-paper md:px-12 md:py-32">
      <div className="mx-auto grid max-w-[1440px] items-center gap-14 md:grid-cols-2 md:gap-24">
        <Reveal>
          <span className="inline-block border border-paper/50 px-5 py-2 text-[0.74rem] font-semibold uppercase tracking-[0.24em]">
            {tourist.badge}
          </span>
          ...
          <p className="mt-6 max-w-lg text-[1.1rem] leading-[1.72] text-paper/90">
            {tourist.text}
          </p>
        </Reveal>
        ...
        <Reveal delay={2} className="md:justify-self-end">
          <a
            href="#booking"
            className="inline-block bg-paper px-9 py-4.5 text-[0.8rem] font-semibold uppercase tracking-[0.16em] text-ink transition-all duration-300 hover:-translate-y-0.5 hover:bg-cream"
          >
            {tourist.cta}
          </a>
          <p className="mt-6 max-w-xs text-[0.95rem] leading-7 text-paper/85">
            {tourist.note}
          </p>
        </Reveal>
      </div>
